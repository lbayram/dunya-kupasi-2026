...
// =====================================================================
window.WC_DATA = {
  lastUpdate: "13 Haziran 2026, 14:10 TSİ",
  headline_en: "Hosts USA thrashed Paraguay 4-1 in Los Angeles in their World Cup opener — a 7th-minute Bobadilla own goal, a Balogun brace (31', 45+5'), a late Maurício reply for Paraguay (73'), and a stoppage-time Gio Reyna goal (90+8') sealed it. The USA lead Group D with 3 points. Day 1 recap: Mexico beat South Africa 2-0 and South Korea beat Czechia 2-1, while hosts Canada earned their first-ever World Cup point with a 1-1 draw against Bosnia and Herzegovina (Lukić 21', Larin 78'). Türkiye's opener against Australia is tomorrow, Sunday June 14 at 07:00 TSİ in Vancouver — Montella's likely XI: Uğurcan Çakır; Zeki Çelik, Merih Demiral, Abdülkerim Bardakcı, Ferdi Kadıoğlu; Çalhanoğlu, Orkun Kökçü; Yunus Akgün, Arda Güler, Barış Alper Yılmaz, Kerem Aktürkoğlu — Kenan Yıldız, recovering from a calf injury, has resumed individual training but whether he's available will only be confirmed on matchday. Bookmakers favour Türkiye. Later today (22:00 TSİ), Group B sees Qatar face Switzerland in Santa Clara.",
  headline: "Ev sahibi ABD, Los Angeles'ta açılış maçında Paraguay'ı 4-1 mağlup etti: 7' Bobadilla'nın kendi kalesine attığı golün ardından Balogun'dan çift (31', 45+5'), Paraguay adına Maurício'dan gol (73') ve uzatmalarda Gio Reyna'dan bir gol (90+8') geldi. ABD, D Grubu'nda 3 puanla lider. 1. gün özeti: Meksika Güney Afrika'yı 2-0, Güney Kore Çekya'yı 2-1 yendi; ev sahibi Kanada ise Bosna Hersek ile 1-1 berabere kalarak Dünya Kupası tarihindeki ilk puanını aldı (Lukić 21', Larin 78'). Türkiye'nin Avustralya ile ilk maçı yarın, 14 Haziran Pazar TSİ 07:00'de Vancouver'da — Montella'nın muhtemel ilk 11'i: Uğurcan Çakır; Zeki Çelik, Merih Demiral, Abdülkerim Bardakcı, Ferdi Kadıoğlu; Çalhanoğlu, Orkun Kökçü; Yunus Akgün, Arda Güler, Barış Alper Yılmaz, Kerem Aktürkoğlu — baldır sakatlığı geçiren Kenan Yıldız bireysel koşulara başladı, kadroya girip girmeyeceği maç günü açıklanacak. Bahis siteleri Türkiye'yi favori gösteriyor. Bugün TSİ 22:00'de B Grubu'nda Katar-İsviçre (Santa Clara) oynanacak.",
  ...
  teamNotes: {
    "Türkiye": "2002 dünya üçüncülüğünden bu yana ilk Dünya Kupası. Hazırlık maçlarında Kuzey Makedonya'yı 4-0, Venezuela'yı 2-1 yendi. Kamp: Mesa, Arizona. Yarın (14 Haziran, TSİ 07:00) Avustralya ile ilk maç — Montella'nın muhtemel ilk 11'i: Uğurcan Çakır; Zeki Çelik, Merih Demiral, Abdülkerim Bardakcı, Ferdi Kadıoğlu; Çalhanoğlu, Orkun Kökçü; Yunus Akgün, Arda Güler, Barış Alper Yılmaz, Kerem Aktürkoğlu — baldır sakatlığı geçiren Kenan Yıldız bireysel koşulara başladı, oynayıp oynamayacağı maç günü açıklanacak. Bahis siteleri Türkiye'yi favori görüyor. Gruptan lider çıkarsa yol: 81 → 94 → 98 → 101 → Final.",
  ...
  teamNotesEn: {
    "Türkiye": "First World Cup since finishing 3rd in 2002. Warmed up with wins over North Macedonia (4-0) and Venezuela (2-1). Base camp: Mesa, Arizona. Tomorrow (June 14, 07:00 TSİ) they open against Australia — Montella's likely XI: Uğurcan Çakır; Zeki Çelik, Merih Demiral, Abdülkerim Bardakcı, Ferdi Kadıoğlu; Çalhanoğlu, Orkun Kökçü; Yunus Akgün, Arda Güler, Barış Alper Yılmaz, Kerem Aktürkoğlu — Kenan Yıldız, recovering from a calf injury, has resumed individual training but his availability will be confirmed on matchday. Bookmakers favour Türkiye. If they top the group: 81 → 94 → 98 → 101 → Final.",
  ...
  facts_en: [
    ...
    "Türkiye's World Cup opener is tomorrow (June 14) at 07:00 TSİ vs Australia in Vancouver; Montella's likely XI features Çalhanoğlu, Arda Güler and Orkun Kökçü, while the injured Kenan Yıldız's availability will be confirmed on matchday, with bookmakers favouring Türkiye."
  ],
  facts: [
    ...
    "Türkiye'nin ilk maçı yarın (14 Haziran) TSİ 07:00'de Vancouver'da Avustralya ile; Montella'nın muhtemel 11'inde Çalhanoğlu, Arda Güler ve Orkun Kökçü öne çıkıyor — sakatlık geçiren Kenan Yıldız'ın kadroya girip girmeyeceği maç günü açıklanacak, bahis siteleri Türkiye'yi favori gösteriyor."
  ]
};
