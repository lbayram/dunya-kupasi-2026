...
// =====================================================================
window.WC_DATA = {
  lastUpdate: "27 Haziran 2026, 21:08 TSİ",
  headline_en: "FINAL GROUP STAGE NIGHT — MATCHES STARTING SOON! England vs Panama and Croatia vs Ghana (Group L) kick off at midnight TSI; Colombia vs Portugal and DR Congo vs Uzbekistan (Group K) at 02:30 TSI; Algeria vs Austria and Jordan vs Argentina (Group J) at 05:00 TSI. All Groups A–I complete. Earlier today: Belgium 5-1 NZ (De Bruyne + Lukaku finally score), Egypt held Iran 1-1 (VAR kills late Iranian goal), Spain 1-0 Uruguay (Baena 42'), Cape Verde 0-0 Saudi Arabia — Cape Verde through to R32 in their FIRST-EVER World Cup! 66 of 72 group-stage matches complete, 6 to go tonight.",
  headline: "GRUP AŞAMASI FİNAL GECESİ — MAÇLAR BAŞLIYOR! İngiltere-Panama ve Hırvatistan-Gana (L Grubu) gece 00:00 TSİ'de; Kolombiya-Portekiz ve DR Kongo-Özbekistan (K Grubu) 02:30 TSİ'de; Cezayir-Avusturya ve Ürdün-Arjantin (J Grubu) 05:00 TSİ'de başlıyor. A-I arası tüm gruplar tamamlandı. Bu sabah: Belçika NZ'yi 5-1 ezdi (De Bruyne + Lukaku ilk gollerini attı), Mısır İran'la 1-1 berabere kaldı (VAR son dakika golünü iptal etti), İspanya Uruguay'ı 1-0 geçti (Baena 42'), Cape Verde S. Arabistan'la 0-0 kalarak Son 32'ye kaldı — ilk Dünya Kupasında tarihî başarı! 72 grup maçının 66'sı bitti, bu gece 6 maç daha.",
  // ---------------- GOL KRALLIĞI ----------------
  topScorers: [
  ...
  topScorersNote: "66 maç tamamlandı. Messi ve Haaland 5'er golle ortak lider. Dembélé, Norveç'e karşı attığı ilk yarı hat-trick'iyle (7', 20', 32') 4 gole ulaşarak Mbappé ve Vinícius Júnior ile ortak 3. sıraya girdi. Sarr (Senegal) ve Just (Yeni Zelanda) da birer golle 3 gole ulaştı — toplamda 3 gol sahiplerinin sayısı artık 7. Kane ve Ronaldo 2'de kaldı (liste dışı). J, K, L grup maçları bu gece oynanacak.",
  topScorersNote_en: "66 matches played. Messi and Haaland still joint top on 5. Dembélé's first-half hat-trick vs Norway (7', 20', 32') brings him to 4 goals, joining Mbappé and Vinícius Júnior in 3rd. Sarr (Senegal, 1 goal vs Iraq) and Just (NZ, 1 goal vs Belgium) also join the 3-goal club — now 7 players tied on 3. Kane and Ronaldo remain on 2 (outside top 10 for now). Groups J, K, L conclude tonight.",
