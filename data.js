...
// =====================================================================
window.WC_DATA = {
  lastUpdate: "27 Haziran 2026, 09:08 TSİ",
  headline_en: "FINAL GROUP STAGE NIGHT: Groups J, K and L conclude tonight (June 27–28 TSI)! Six decisive matches will complete the bracket: Argentina vs Jordan, Algeria vs Austria (Group J); England vs Panama, Croatia vs Ghana (Group L); Colombia vs Portugal, DR Congo vs Uzbekistan (Group K). All Groups A–I are now complete. Yesterday: Belgium 5-1 NZ (De Bruyne + Lukaku finally score), Egypt held Iran 1-1 (VAR kills late Iranian goal), Spain 1-0 Uruguay (Baena 42'), Cape Verde 0-0 Saudi Arabia — Cape Verde through to R32 in their FIRST-EVER World Cup! 66 of 72 group-stage matches complete.",
  headline: "GRUP AŞAMASI SON GECE: J, K ve L Grupları bu gece (27–28 Haziran TSİ) tamamlanıyor! 6 belirleyici maç: Arjantin-Ürdün, Cezayir-Avusturya (J Grubu); İngiltere-Panama, Hırvatistan-Gana (L Grubu); Kolombiya-Portekiz, DR Kongo-Özbekistan (K Grubu). A'dan I'ya tüm gruplar bitti. Dün: Belçika NZ'yi 5-1 ezdi (De Bruyne + Lukaku ilk gollerini attı), Mısır İran'la 1-1 berabere kaldı (VAR son dakika golünü iptal etti), İspanya Uruguay'ı 1-0 geçti (Baena 42'), Cape Verde S. Arabistan'la 0-0 kalarak Son 32'ye kaldı — ilk Dünya Kupasında tarihî başarı! 72 grup maçının 66'sı tamamlandı.",
  // ---------------- GOL KRALLIĞI ----------------
  topScorers: [
